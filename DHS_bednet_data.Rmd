...
#### create dataset from files not in household. (deprecated). run one time after updating variables or adding surveys
...
count(i, country, survey, year)

cat( "There are", nrow(i), "children with a either a positve or negative parsitemia result" )
